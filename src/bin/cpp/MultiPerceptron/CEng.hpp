...
//			);
    ...
    class Engine<T, MODE_E>::ParametersEngine {
        ...
        using Prev_Linked_t = std::remove_pointer_t<prev_t>;
        using Next_Linked_t = std::remove_pointer_t<next_t>;
      ...
      public:
        ...
        constexpr inline void compute_forward(size_t iter);

        constexpr inline void compute_backward(size_t iter);

        constexpr inline void compute_update(size_t iter);
    };
