...
namespace CEng {
    ...
    public:
        ...
        template<debug_e DEBUG_E, class Prev_Linked_Ptr_t, class Next_Linked_Ptr_t>
        auto get_engine(Prev_Linked_Ptr_t prevLinkedPtr, Next_Linked_Ptr_t nextLinkedPtr);
    ...
    template<debug_e DEBUG_E, class Prev_Linked_Ptr_t, class Next_Linked_Ptr_t>
    auto Engine::get_engine(Prev_Linked_Ptr_t prevLinkedPtr, Next_Linked_Ptr_t nextLinkedPtr) {
        return InnerEngine<DEBUG_E, Prev_Linked_Ptr_t, Next_Linked_Ptr_t>(prevLinkedPtr, nextLinkedPtr);
