...
MpiSlave::MpiSlave(int myrank, int proccount, AData_t *oDataGen, ACalc_t *oResults) :
		myrank(myrank), proccount(proccount), oDataGen(oDataGen), oResults(oResults) {
...
int MpiSlave::run_while() {
	...
	do {
		...
		SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while 1 : \n", ++cnt, currItemId, prevItemId);
		...
		if (doBreak) {
			SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while : DO BREAK  \n", ++cnt, currItemId, prevItemId);
			break;
		}
...
int MpiSlave::run_while_calc() {
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_calc START\n", ++cnt, currItemId, prevItemId);
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_calc END\n", ++cnt, currItemId, prevItemId);
...
int MpiSlave::run_while_isend() {
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_isend START\n", ++cnt, currItemId, prevItemId);
...
bool MpiSlave::run_while_irecv() {
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_irecv START\n", ++cnt, currItemId, prevItemId);
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_irecv END : DONT BREAK \n", ++cnt, currItemId, prevItemId);
...
int MpiSlave::run_while_irecv_tag_data() {
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_irecv_tag_data START : status.MPI_TAG == DATA \n", ++cnt, currItemId, prevItemId);
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_irecv_tag_data END : WHILE item (id[0]: %d, id[1]: %d) \n", ++cnt, currItemId, prevItemId, oItemIdem[0].id, oItemIdem[1].id);
...
int MpiSlave::run_while_irecv_tag_finish() {
	...
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_irecv_tag_finish START : status.MPI_TAG == FINISH \n", ++cnt, currItemId, prevItemId);
	SDPPR4(myrank, "(%d ) item id (C: %d, NPATTERNS: %d) run_while_irecv_tag_finish END : FINALIZE \n", ++cnt, currItemId, prevItemId);
