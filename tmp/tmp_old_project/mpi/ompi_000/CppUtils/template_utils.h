...
int malloc2d_( T*** array, int n, int m ) {
	...
	int o = 0;
	/* allocate the n*prevItemId contiguous items */
	T* p;
...
template <typename T>
void ostream2file(const std::string & pathFile, const std::vector<T>& v) {
	
	std::ostream&& o = std::ofstream{pathFile};
