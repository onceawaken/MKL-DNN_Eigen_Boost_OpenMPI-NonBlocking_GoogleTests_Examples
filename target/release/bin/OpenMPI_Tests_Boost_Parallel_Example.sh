...
echo "OpenMPI_Tests_Boost_Parallel_Example RUNNER..."
...
TARGET=/home/egrzrbr/W/W.priv/HPC/NonBlockingProtocol/target/release/bin/OpenMPI_Tests_Boost_Parallel_Example
