...
macro(setup_openmpi)
    ...
    if (DEFINED ARGN1)
        ...
        set(OMPI_DIR ${CMAKE_LIBRARY_PATH}/OpenMPI)
    endif ()
...
macro(add_executable_mpi TARGET MPI_NP)
    assert_ompi()
    ...
    set_target_properties(${TARGET} PROPERTIES FOLDER ${CMAKE_LIBRARY_DIR_RELATIVE})
    ...
    configure_file(${CMAKE_SOURCE_DIR}/src/run_mpi.sh.in ${RUNTIME_OUTPUT_DIR}/${TARGET}.sh)
